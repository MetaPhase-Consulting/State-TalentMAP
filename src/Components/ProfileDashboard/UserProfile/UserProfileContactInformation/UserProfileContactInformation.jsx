  ...
  <div className="current-user-section-container">
    <div className="section-padded-inner-container">
      ...
      <InformationDataPoint
        title="Email address"
        content={
          get(userProfile, 'user_info.email') ? (
            <a
              href={`mailto:${get(userProfile, 'user_info.email')}`}
              rel="nofollow"
            >
              {get(userProfile, 'user_info.email')}
            </a>
      ...
      <InformationDataPoint
        title="Office number"
        content={
          get(userProfile, 'user_info.office_phone') ? (
            <a
              href={`tel:${get(userProfile, 'user_info.office_phone')}`}
              rel="nofollow"
            >
              {get(userProfile, 'user_info.office_phone')}
            </a>
      ...
      <StaticDevContent>
        <InformationDataPoint
          ...
          content={(
            <a href="tel:+240-331-7189" rel="nofollow">
              +240-331-7189
            </a>
          )}
        />
      ...
      <InformationDataPoint
        ...
        content={
          get(userProfile, 'user_info.office_address') || NO_OFFICE_ADDRESS
        }
      />
    </div>
  </div>
