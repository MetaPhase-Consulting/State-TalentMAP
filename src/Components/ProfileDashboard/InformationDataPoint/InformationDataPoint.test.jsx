...
describe('InformationDataPointComponent', () => {
  ...
  it('is defined when titleOnBottom is true', () => {
    const wrapper = shallow(
      <InformationDataPoint content="content" titleOnBottom />,
    );
    expect(wrapper).toBeDefined();
  });
  ...
  it('receives the className prop', () => {
    const wrapper = shallow(
      <InformationDataPoint content="content" className="test-class" />,
    );
  ...
  it('renders the data-point-title div when title is present', () => {
    const wrapper = shallow(
      <InformationDataPoint content="c" title="t" className="test-class" />,
    );
  ...
  it('matches snapshot', () => {
    const wrapper = shallow(
      <InformationDataPoint content="content" title="title" />,
    );
  ...
  it('matches snapshot when titleOnBottom is true', () => {
    const wrapper = shallow(
      <InformationDataPoint content="content" titleOnBottom title="title" />,
    );
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
  ...
  it('matches snapshot when sideBySide is true', () => {
    const wrapper = shallow(
      <InformationDataPoint content="content" sideBySide title="title" />,
    );
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
});
