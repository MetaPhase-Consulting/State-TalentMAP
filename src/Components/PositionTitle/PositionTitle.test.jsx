...
describe('PositionTitleComponent', () => {
  ...
  it('can receive props', () => {
    const wrapper = shallow(<PositionTitle {...props} />);
  ...
  it('displays the OBC link if post_overview_url exists', () => {
    ...
    newDetailsObject.post.post_overview_url = {
      internal: 'url',
      external: 'url2',
    };
    const wrapper = shallow(
      <PositionTitle {...props} details={newDetailsObject} />,
    );
  ...
  it('matches snapshot', () => {
    const wrapper = shallow(
      <PositionTitle {...props} details={detailsObject} />,
    );
