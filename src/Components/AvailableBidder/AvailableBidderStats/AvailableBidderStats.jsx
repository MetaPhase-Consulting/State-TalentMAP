...
const AvailableBidderStats = () => {
  ...
  return !availableBiddersIsLoading && !statsSum && !!isNoBidders ? null : (
      ...
      <div className="usa-grid-full">
        <Row className="usa-grid-full">
          <div className="usa-grid-full toggle-more-container">
            ...
            >
              <h3>
                <FA name="pie-chart" /> Statistics{' '}
                <FA name={`chevron-${showMore ? 'down' : 'right'}`} />
              </h3>
            </InteractiveElement>
          </div>
          {showMore && (
            <div className="usa-grid-full section statistics-section">
              ...
              {!availableBiddersIsLoading
                && !statsSum
                && 'There are no available bidders categorized by status.'}
