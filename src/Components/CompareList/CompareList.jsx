...
export const renderBidCounts = (compareArray, emptyArray) => (
  <tr>
    ...
    {emptyArray.map(() => (
      <td className="empty" key={shortId.generate()} />
    ))}
  </tr>
);
...
class CompareList extends Component {
  ...
  render() {
    const {
      compare, isLoading, favorites, onToggle,
    } = this.props;
    const limit = 5;
              ...
              <table className="tm-table">
                ...
                <thead className="usa-sr-only">
                  <tr>
                    ...
                    {emptyArray.map(() => (
                      <th className="empty" key={shortId.generate()}>
                        Return to search results and add more positions to
                        compare.
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                    ...
                    {compareArray.map((c) => {
                      ...
                      return (
                        <td key={shortId.generate()}>
                          ...
                          <span
                            aria-labelledby={getAccessiblePositionNumber(
                  ...
                  <tr>
                    ...
                    {compareArray.map((c) => (
                      <td key={shortId.generate()}>
                        <LanguageList
                          languages={c.position.languages}
                  ...
                  <tr>
                    ...
                    {compareArray.map((c) => {
                      ...
                      const postDifferential = get(
                        c,
                        'position.post.differential_rate',
                      );
                      const obcUrl = get(
                        c,
                        'position.post.post_bidding_considerations_url',
                      );
                      ...
                      <MediaQuery breakpoint="screenLgMin" widthType="min">
                        {(matches) => (
                          <td
                            ...
                            className="compare-ribbon"
                          >
                            {get(
                              c,
                              'bid_statistics[0].has_handshake_offered',
                              false,
                            ) && (
                              <Handshake
                                shortName
