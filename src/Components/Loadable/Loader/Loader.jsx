...
const createLoader = ({ path, delay = 500, shouldPreload = true, timeout = 3000, size = 'small', useAnimation = true }) => {
  const Loader = Loadable({
    loader: path,
    loading: useAnimation ? props => <LoadingWrapper {...props} size={size} /> : () => null,
    delay,
  });
