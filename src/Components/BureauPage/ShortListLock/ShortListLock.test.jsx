...
describe('ShortListLock', () => {
  ...
  it('is defined when status === true', () => {
    const wrapper = shallow(
      <ShortListLock.WrappedComponent {...props} status />,
    );
    expect(wrapper).toBeDefined();
  });
  ...
  it('is defined when statusHasErrored and statusUpdateHasErrored === true', () => {
    const wrapper = shallow(
      <ShortListLock.WrappedComponent
        {...props}
        statusHasErrored
  ...
  it('is defined when statusUpdateIsLoading === true', () => {
    const wrapper = shallow(
      <ShortListLock.WrappedComponent {...props} statusUpdateIsLoading />,
    );
    expect(wrapper).toBeDefined();
  });
  ...
  it('is defined when statusIsLoading === true', () => {
    const wrapper = shallow(
      <ShortListLock.WrappedComponent {...props} statusIsLoading />,
    );
    expect(wrapper).toBeDefined();
  });
