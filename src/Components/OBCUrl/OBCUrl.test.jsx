...
describe('OBCUrlComponent', () => {
  ...
  it('is defined', () => {
    const wrapper = shallow(<OBCUrl url={url} />);
  ...
  it('matches snapshot when type is "post-data"', () => {
    const wrapper = shallow(<OBCUrl url={url} type="post-data" />);
    expect(toJSON(wrapper)).toMatchSnapshot();
  });

  it('matches snapshot when type is "country"', () => {
    const wrapper = shallow(<OBCUrl url={url} type="country" />);
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
  ...
  it('matches snapshot when isButton is true', () => {
    const wrapper = shallow(<OBCUrl url={url} isButton />);
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
});
