...
describe('ResultsSearchHeaderComponent', () => {
  ...
  it('is defined', () => {
    wrapper = shallow(<ResultsSearchHeader {...props} />);
    expect(wrapper).toBeDefined();
  });

  it('is defined without a defaultKeyword', () => {
    wrapper = shallow(<ResultsSearchHeader {...props} defaultKeyword={null} />);
    expect(wrapper).toBeDefined();
  });
  ...
  it('can call the onUpdate function', () => {
    const spy = sinon.spy();
    wrapper = shallow(<ResultsSearchHeader {...props} onUpdate={spy} />);
    wrapper.instance().props.onUpdate();
    expect(spy.calledOnce).toBe(true);
  });

  it('can call the changeText function', () => {
    wrapper = shallow(<ResultsSearchHeader {...props} onUpdate={() => {}} />);
