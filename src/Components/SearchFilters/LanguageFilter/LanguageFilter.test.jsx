...
describe('LanguageFilterComponent', () => {
  ...
  it('can receive props', () => {
    const wrapper = shallow(<LanguageFilter {...props} />);
  ...
  it('can call the onCheckBoxClick function', () => {
    ...
    const wrapper = shallow(
      <LanguageFilter {...props} queryParamToggle={spy} />,
    );
    wrapper
      .instance()
  ...
  it('can call the onGroupCheckBoxClick function', () => {
    const spy = sinon.spy();
    const wrapper = shallow(
      <LanguageFilter {...props} queryParamUpdate={spy} />,
    );
    wrapper
      .instance()
      .onGroupCheckBoxClick(true, {
        selectionRef: 'test',
        code: 'code',
        cone: languageGroups.data[0],
      });
    sinon.assert.calledOnce(spy);
  });
